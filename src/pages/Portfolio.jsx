        ...
        {datas.map((d, i) => (
          ...
          >
            ...
            <div className="flex space-x-2 mt-4">
              {d.technologies.map((e, i) => (
                <div className=" w-10 h-10 p-2 rounded-full bg-white dark:bg-zinc-900 flex justify-center items-center"><img src={`./icons/${e}-icon.png`} alt="" /></div>
              ))}
            </div>
            <div className="flex flex-col mt-4">
              <span className=" font-bold">{d.projName}</span>
